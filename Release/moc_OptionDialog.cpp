...
#include "../../../../../../Downloads/LinuxHex-1.0/OptionDialog.h"
...
QT_MOC_LITERAL(3, 23, 14), // "Highlight_Func"
QT_MOC_LITERAL(4, 38, 12), // "Address_Func"
QT_MOC_LITERAL(5, 51, 14), // "Selection_Func"
QT_MOC_LITERAL(6, 66, 9) // "Font_Func"

    },
    "OptionDialog\0accepted\0\0Highlight_Func\0"
    "Address_Func\0Selection_Func\0Font_Func"
};
...
void OptionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->Highlight_Func(); break;
        case 2: _t->Address_Func(); break;
        case 3: _t->Selection_Func(); break;
        case 4: _t->Font_Func(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionDialog::accepted)) {
                *result = 0;
                return;
            }
        }
