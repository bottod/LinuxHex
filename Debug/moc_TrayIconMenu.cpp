/****************************************************************************
** Meta object code from reading C++ file 'TrayIconMenu.h'
**
...
#error "The header file 'TrayIconMenu.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TrayIconMenu_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject TrayIconMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_TrayIconMenu.data,
      qt_meta_data_TrayIconMenu,  qt_static_metacall, nullptr, nullptr}
};
...
void *TrayIconMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TrayIconMenu.stringdata0))
